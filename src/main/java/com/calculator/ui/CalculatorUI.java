...
import com.calculator.theme.ThemeLoader;
import static com.calculator.util.ColorUtil.hex2Color;
...
public class CalculatorUI {
    ...
    public double calculate(double firstNumber, double secondNumber, char operator) {
        switch (operator) {
            ...
            case '*':
                return firstNumber * secondNumber;
            case '/':
                return (secondNumber != 0) ? firstNumber / secondNumber : Double.POSITIVE_INFINITY;
            case '%':
                return (secondNumber != 0) ? firstNumber % secondNumber : Double.NaN;
            case '^':
                return Math.pow(firstNumber, secondNumber);
            case '√':
                return (firstNumber > 0) ? Math.sqrt(firstNumber) : Double.NaN;
            default:
                return secondNumber;
        }
    }
    ...
    private void initThemeSelector() {
        ...
        comboTheme.addItemListener(event -> {
            ...
            applyTheme(themeMap.get(selectedTheme));
        });
    ...
    //Init Menu choose Calculator type
